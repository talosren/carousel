...
const claudeLight = {
  tagColor: "#d97706",
  headingColor: "rgba(17,24,39,0.96)",
  bodyColor: "#6b7280",
  slideBg: "#f8f6f2",
  slideScrim:
    "linear-gradient(180deg, rgba(248,246,242,0.55) 0%, rgba(248,246,242,0.8) 60%, rgba(248,246,242,0.94) 100%)",
  pillBg: "rgba(17,24,39,0.04)",
  pillBorder: "rgba(17,24,39,0.08)",
  pillColor: "#6b7280",
  pillStrikeColor: "rgba(17,24,39,0.45)",
  pillStrikeBorder: "rgba(17,24,39,0.14)",
  featureIcon: "#d97706",
  featureLabel: "rgba(17,24,39,0.96)",
  featureDesc: "#6b7280",
  featureBorder: "rgba(17,24,39,0.1)",
  stepNum: "#d97706",
  stepTitle: "rgba(17,24,39,0.96)",
  stepDesc: "#6b7280",
  stepBorder: "rgba(17,24,39,0.1)",
  watermarkColor: "rgba(17,24,39,0.96)",
  ctaBg: "#ffffff",
  ctaText: "#92400e",
  logoBg: "#d97706",
  logoText: "#ffffff",
  logoName: "rgba(17,24,39,0.96)",
  promptBg: "rgba(17,24,39,0.05)",
  promptBorder: "rgba(17,24,39,0.08)",
  promptLabel: "#6b7280",
  promptText: "rgba(17,24,39,0.96)",
  mediaBorder: "rgba(17,24,39,0.1)",
  mediaBg: "rgba(17,24,39,0.03)",
};
...
const claudeDark = {
  ...
  slideBg: "#1f1a17",
  slideScrim:
    "linear-gradient(180deg, rgba(31,26,23,0.35) 0%, rgba(31,26,23,0.78) 60%, rgba(31,26,23,0.94) 100%)",
  pillBg: "rgba(255,255,255,0.06)",
  pillBorder: "rgba(255,255,255,0.08)",
  pillColor: "#f8f6f2",
  pillStrikeColor: "rgba(255,255,255,0.5)",
...
const claudeBrand = {
  tagColor: "rgba(255,255,255,0.68)",
  headingColor: "#ffffff",
  bodyColor: "rgba(255,255,255,0.84)",
  slideBg: "linear-gradient(135deg, #d97706 0%, #7c2d12 100%)",
  slideScrim:
    "linear-gradient(180deg, rgba(217,119,6,0.32) 0%, rgba(124,45,18,0.74) 60%, rgba(124,45,18,0.94) 100%)",
  pillBg: "rgba(255,255,255,0.1)",
  pillBorder: "rgba(255,255,255,0.16)",
  pillColor: "#ffffff",
  pillStrikeColor: "rgba(255,255,255,0.55)",
...
export const notionTheme = {
  ...
  caption: {
    text: "The workspace that thinks with you. A single home for notes, docs, and projects — quietly organized, deeply yours.",
    meta: "2 HOURS AGO",
  },
  colors: {
    primary: "#0075de",
...
export const midnightTheme = {
  ...
  caption: {
    text: "A calm, high-contrast canvas for late-night thinking. Violet rhythm, soft stars, focused work.",
    meta: "5 HOURS AGO",
  },
  colors: {
    primary: "#7a5cff",
...
export const claudeTheme = {
  ...
  caption: {
    text: "Meet the thoughtful AI built for clarity, writing, and deep work. Calmly powerful assistance for whatever you’re building.",
    meta: "2 HOURS AGO",
  },
  ...
  colors: {
    ...
    light: "#f8f6f2",
    dark: "#1f1a17",
    ink: "rgba(17,24,39,0.96)",
    inkMuted: "#6b7280",
    inkFaint: "#b2aaa0",
    gradientFrom: "#d97706",
    gradientTo: "#7c2d12",
    whisper: "rgba(17,24,39,0.1)",
  },
